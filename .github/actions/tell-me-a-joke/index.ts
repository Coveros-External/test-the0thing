...
// TODO: Add logic to make it not fail if one of the issues does not have the required information or if it's formatted improperly.
// Instead just have it skip that issue and move on to the next one, that way we can tell which ones are not formatted correctly and fix them

// TODO: Add a way to shame ChatGPT for telling hideous jokes
